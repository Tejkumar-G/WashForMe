...
import com.example.washforme.core.domain.model.Address
import com.example.washforme.core.domain.model.AddressType
...
class AddressViewModel @Inject constructor(
    ...
    val pref: PreferenceManagerImpl
    ...
    fun changeCurrentAddress(id: String) {
        viewModelScope.launch(Dispatchers.Default) {
